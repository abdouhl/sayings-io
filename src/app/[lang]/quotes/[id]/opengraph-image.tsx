  ...
  try {
    ...
    if (!quote) {
      ...
      return new ImageResponse(
        ...
        >
          <div style={{ fontSize: 36, opacity: 0.8, display: "flex" }}>Quote not found</div>
        </div>,
        { ...size },
      )
    }
      ...
      >
        ...
        <div
          style={{
            ...
            width: "880px", // Fixed width (1000 - 60*2)
            height: "1380px", // Fixed height (1500 - 60*2)
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            justifyContent: "center",
    ...
    return new ImageResponse(
      ...
      >
        <div style={{ fontSize: 36, opacity: 0.8, display: "flex" }}>Error generating image</div>
      </div>,
      { ...size },
    )
  }
