...
export function MobileMenu({ lang, dictionary, isRtl = false }: MobileMenuProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side={isRtl ? "left" : "right"} className="w-[250px] sm:w-[300px]">
        <SheetHeader className="mb-6">
          <SheetTitle className={isRtl ? "text-right" : "text-left"}>Sayings</SheetTitle>
        </SheetHeader>
