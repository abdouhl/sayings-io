...
export function Pagination({ currentPage, totalPages, lang, dictionary = {}, baseUrl }: PaginationProps) {
        ...
        {visiblePageNumbers.map((pageNumber, index) =>
          pageNumber === -1 ? (
            ...
            <PaginationItem key={pageNumber}>
              <PaginationLink href={`${urlBase}?page=${pageNumber}`} isActive={pageNumber === currentPage}>
                {pageNumber}
              </PaginationLink>
            </PaginationItem>
          ),
